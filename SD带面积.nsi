...
Section Uninstall
  ...
  Delete "$INSTDIR\DevExpress.Charts.v14.2.Core.dll"
  ...
  Delete "$INSTDIR\DevExpress.XtraCharts.v14.2.dll"
  Delete "$INSTDIR\DevExpress.XtraCharts.v14.2.UI.dll"
  Delete "$INSTDIR\DevExpress.XtraCharts.v14.2.Wizard.dll"
